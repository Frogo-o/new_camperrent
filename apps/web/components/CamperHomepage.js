...
const steps = [
  ...
  {
    title: "Изграждане",
    text: "Интериор, мебели и всички детайли за твоя кемпър с практични решения за комфорт при пътуване.",
  },
];
...
function getRentMeta(product) {
  return product?.brand?.name || product?.articleNumber || "Напълно оборудвани";
}
      ...
      <div className="p-6">
        ...
        <div className="mt-6 flex items-center justify-between gap-4">
          <div>
            ...
            <div className="text-xl font-semibold text-[#00A6F4]">
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:py-24">
            <div className="relative z-10 flex flex-col justify-center">
              ...
              <h1 className="max-w-4xl text-5xl font-semibold leading-tight tracking-tight text-[#2f658e] sm:text-6xl lg:text-7xl">
                Всичко за кемпъри и каравани на едно място
              </h1>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link href="/store" className="rounded-full bg-[#00A6F4] px-6 py-3.5 font-medium text-white shadow-xl shadow-[#00A6F4]/15 transition hover:scale-[1.02] hover:bg-[#0298df]">
                  Онлайн магазин
                </Link>
                <Link href="/rent" className="rounded-full border border-[#00A6F4] bg-white px-6 py-3.5 font-medium text-[#00A6F4] transition hover:scale-[1.02] hover:bg-[#eef8ff]">
                  Наеми Кемпер
                </Link>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex w-full items-center gap-8 overflow-hidden">
                <div className="partner-marquee relative w-full overflow-hidden">
                  <div className="partner-marquee-track flex items-center gap-10 whitespace-nowrap pr-10">
        ...
        <section id="rent" className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-slate-600">
              Кемпери под наем в България - разнообразие от модели с 2 до 7 места, напълно оборудвани и готови за следващото ти пътуване.
            </p>
          </div>
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            {rentals.length > 0
              ...
              : (
                <EmptyStateCard
                  title="Подготвяме нови предложения"
                  text="Скоро тук ще видиш активните модели за наем с актуални снимки и цени."
                  href="/rent"
                  cta="Към всички предложения"
                />
              )}
          </div>
        </section>
            ...
            {campersForSale.length > 0
              ...
              : (
                <EmptyStateCard
                  ...
                  text="Актуалните оферти за покупка ще се покажат тук веднага щом са налични."
                  href="/buy"
                  cta="Към офертите"
                />
              )}
